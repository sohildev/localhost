...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServiceAreaServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(AreaService, [{
        key: "getAreaList",
        value: function getAreaList(param) {
          return this.http.get("".concat(this.API_URL, "/area"), {
            params: param
          });
        }
      }, {
        ...
        value: function addArea(data) {
          return this.http.post("".concat(this.API_URL, "/area"), data);
        }
      }, {
        key: "editArea",
        value: function editArea(id, data) {
          return this.http.put("".concat(this.API_URL, "/area/").concat(id), data);
        }
      }, {
        key: "getAreaById",
        value: function getAreaById(id) {
          var param = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
          return this.http.get("".concat(this.API_URL, "/area/").concat(id), {
            params: param
          });
        }
      }]);
