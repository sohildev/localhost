...
/* harmony import */ var src_app_service_client_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/service/client.service */ "./src/app/service/client.service.ts");
...
let AddClientComponent = class AddClientComponent {
    constructor(router, activatedRoute, fb, clientService, commonService) {
        this.router = router;
    ...
    getEditObject() {
        this.clientService.getClientById(this.editId).subscribe((response) => {
            if (response.success) {
                ...
                this.router.navigateByUrl('/manage/client');
            }
        });
    }
    ...
    submitForm(formData) {
        if (formData.valid) {
            ...
            if (this.isEditing) {
                this.clientService.editClient(this.editId, data).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('/manage/client');
                    }
                        ...
                        response.error.map(obj => {
                            if (obj.hasOwnProperty('client_code')) {
                                this.formErrors['client_code'] = obj['client_code'];
                            }
                            else {
...
AddClientComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-client',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./add-client.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/master/client/add-client/add-client.component.html")).default
    })
], AddClientComponent);
...
let ClientListComponent = class ClientListComponent {
    constructor(paginationService, clientService) {
    ...
    getObjects() {
        ...
        this.clientService.getClientList(params).subscribe((response) => {
            this.loadingState = false;
            if (response.success) {
...
ClientListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./client-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/master/client/client-list/client-list.component.html")).default
    })
], ClientListComponent);
...
/* harmony import */ var _client_list_client_list_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./client-list/client-list.component */ "./src/app/pages/master/client/client-list/client-list.component.ts");
/* harmony import */ var _add_client_add_client_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./add-client/add-client.component */ "./src/app/pages/master/client/add-client/add-client.component.ts");
/* harmony import */ var src_app_service_client_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/service/client.service */ "./src/app/service/client.service.ts");
...
let ClientService = class ClientService {
    ...
    getClientList(param) {
        return this.http.get(`${this.API_URL}/client`, { params: param });
    }
    addClient(data) {
        return this.http.post(`${this.API_URL}/client`, data);
    }
    editClient(id, data) {
        return this.http.put(`${this.API_URL}/client/${id}`, data);
    }
    getClientById(id, param = null) {
        return this.http.get(`${this.API_URL}/client/${id}`, { params: param });
    }
};
