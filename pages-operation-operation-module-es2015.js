...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | add-bin-transfer-add-bin-transfer-module */ "add-bin-transfer-add-bin-transfer-module").then(__webpack_require__.bind(null, /*! ./add-bin-transfer/add-bin-transfer.module */ "./src/app/pages/operation/add-bin-transfer/add-bin-transfer.module.ts")).then(m => m.AddBinTransferModule)
    },
    {
        path: 'transfer-order',
