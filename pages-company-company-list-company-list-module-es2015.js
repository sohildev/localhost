...
const routes = [
    ...
    {
        path: 'add',
        loadChildren: () => Promise.all(/*! import() | company-add-company-add-module */[__webpack_require__.e("default~add-order-add-order-module~add-put-away-add-put-away-module~add-registeration-add-registerat~d94f3084"), __webpack_require__.e("company-add-company-add-module")]).then(__webpack_require__.bind(null, /*! ../company-add/company-add.module */ "./src/app/pages/company/company-add/company-add.module.ts")).then(m => m.CompanyAddModule),
